...
DROP POLICY tenant_isolation ON app.memberships;
...
DROP POLICY tenant_isolation ON app.tenants;
...
-- ---------- app.tenant_branding --------------------------------------------
DROP POLICY tenant_isolation ON app.tenant_branding;
...
DROP POLICY tenant_isolation ON billing.afip_credentials;
...
-- para su empresa.
DROP POLICY tenant_isolation ON app.roles;
